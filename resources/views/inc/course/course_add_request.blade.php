                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        ...
                        <div class="autocomplete" style="width:300px">
                            <input name="course_code" id="course_code_field" type="text"
                                class="form-control" placeholder="Ex: MATH 1300" aria-label="course_code">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button id="save_changes" type="submit" class="btn btn-primary">Submit Request</button>
                </div>
            </div>
        </div>
    </div>
