                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item" href="{{ route('profile', Auth::user()->username ) }}"> 
                            <i class="material-icons-outlined nv-icon-22">person</i>  
                            <span class="ml-3">Profile</span></a>
                        </a>
                        
                        <a class="dropdown-item" href=""> 
                            <i class="material-icons-outlined nv-icon-22">settings</i>
                        ...
                        <a class="dropdown-item" href="{{ route('admin') }}" target="_blank"> 
                            <i class="material-icons-outlined nv-icon-22">admin_panel_settings</i>
